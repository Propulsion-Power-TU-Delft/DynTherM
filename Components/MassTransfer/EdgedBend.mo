...
model EdgedBend
  "Pressure drop due to edged bend according to Modelica standard library"
  ...
  Modelica.Fluid.Dissipation.PressureLoss.Bend.dp_edgedOverall_IN_var In_var(eta=Medium.dynamicViscosity(state), rho=rho);
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={                                                                                                                                                                  Line(origin={-60,60},    points={{-40,-20},
              {20,-20},{20,40}},                                                                                                                                                                                                        color={0,0,0}),                                                  Line(origin={-20,20},    points={{-80,-60},
              {60,-60},{60,80}},                                                                                                                                                                                                        color={0,0,0}),
        Line(
          points={{-40,100},{40,100}},
          color={0,0,0}),
        Line(
          points={{-100,40},{-100,-40}},
          color={0,0,0}),                                                                                                                                                                                                        Line(origin={-60,40},    points={{-40,-20},
              {40,-20},{40,60}},                                                                                                                                                                                                        color={0,0,0}),                                                  Line(origin={-40,20},    points={{-60,-40},
              {60,-40},{60,80}},                                                                                                                                                                                                        color={0,0,0})}),
                                                                      Diagram(
