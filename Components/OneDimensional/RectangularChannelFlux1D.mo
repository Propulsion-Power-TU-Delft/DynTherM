...
model RectangularChannelFlux1D
  ...
  CustomInterfaces.OneDimensional.HeatFluxPort1D_B solid_surface_north(Nx=N_cv) annotation (Placement(transformation(extent={{-90,16},{-60,76}}),
        iconTransformation(extent={{-90,16},{-60,76}})));
  CustomInterfaces.OneDimensional.HeatFluxPort1D_B solid_surface_east(Nx=N_cv) annotation (Placement(transformation(extent={{-40,16},{-10,76}}),
        iconTransformation(extent={{-40,16},{-10,76}})));
  CustomInterfaces.OneDimensional.HeatFluxPort1D_B solid_surface_south(Nx=N_cv) annotation (Placement(transformation(extent={{10,16},{40,76}}),
        iconTransformation(extent={{10,16},{40,76}})));
  CustomInterfaces.OneDimensional.HeatFluxPort1D_B solid_surface_west(Nx=N_cv) annotation (Placement(transformation(extent={{60,16},{90,76}}),
