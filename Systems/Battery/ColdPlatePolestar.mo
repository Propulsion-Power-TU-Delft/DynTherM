 ...
 parameter Choices.PDropOpt DP_opt
  ...
  CustomInterfaces.Adaptors.heatFlowInverter2D ChannelInvert1_6(Nx=N_cv, Ny=3)
    annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={-22,-62})));
  CustomInterfaces.OneDimensional.HeatPort1D_A Bottom(Nx=N_cv) annotation (Placement(transformation(
        extent={{-32,-30},{32,30}},
        rotation=90,
        origin={140,0}), iconTransformation(extent={{-30,-62},{26,-6}})));
  CustomInterfaces.OneDimensional.HeatPort1D_A Top(Nx=N_cv) annotation (
  ...
  CustomInterfaces.ZeroDimensional.FluidPort_A inlet(
    ...
    Xi_outflow(start=X_start)) annotation (Placement(transformation(extent={{-86,-50},
            {-74,-38}},      rotation=0), iconTransformation(extent={{-96,2},{-84,
            14}})));
  CustomInterfaces.ZeroDimensional.FluidPort_B outlet(
    ...
    P(start=P_start),
    h_outflow(start=Medium.specificEnthalpy(state_start)),
    Xi_outflow(start=X_start)) annotation (Placement(transformation(extent={{-86,-82},
            {-74,-70}},      rotation=0), iconTransformation(extent={{-96,-12},
            {-84,0}})));
...
equation
  ...
  connect(Channel1.inlet, inlet) annotation (Line(points={{-44,-43},{-44,-44},{-80,
          -44}},                     color={0,0,0}));
  ...
  connect(Channel6.TopSurface, Channel6ToTopInvert.input1D) annotation (Line(
        ...
        color={0,140,72}));
  connect(Channel6ToTopInvert.output1D, Bottom) annotation (Line(points={{108.14,
          -14.06},{116,-14.06},{116,0},{140,0}}, color={0,140,72}));
  connect(Channel2ToTopInvert.output1D, Bottom) annotation (Line(points={{106.14,
          9.94},{116,9.94},{116,0},{140,0}}, color={0,140,72}));
  ...
  connect(Channel4.TopSurface, Channel4ToTopInvert.input1D) annotation (Line(
        points={{11.44,35.54},{11.44,30},{97.86,30},{97.86,29.94}}, color={0,140,
          72}));
  connect(Channel4ToTopInvert.output1D, Bottom) annotation (Line(points={{106.14,
          29.94},{106.14,30},{116,30},{116,0},{140,0}}, color={0,140,72}));
  ...
  connect(Channel2.BottomSurface, Channel2ToBottomInvert.output1D) annotation (
      Line(points={{10.92,-7.01},{-4,-7.01},{-4,-18},{-46,-18},{-46,9.94},{-105.86,
          9.94}}, color={0,140,72}));
  connect(Channel6ToBottomInvert.input1D, Top) annotation (Line(points={{-114.14,
          -16.06},{-120,-16.06},{-120,0},{-140,0}}, color={0,140,72}));
  ...
  connect(Channel4ToBottomInvert.input1D, Top) annotation (Line(points={{-114.14,
          29.94},{-120,29.94},{-120,0},{-140,0}}, color={0,140,72}));
  connect(Channel2ToBottomInvert.input1D, Top) annotation (Line(points={{-114.14,
          9.94},{-120,9.94},{-120,0},{-140,0}}, color={0,140,72}));
