...
model PouchCellModuleManual1D
  ...
  Components.OneDimensional.WallConductionHorizontal1D frame_top(
  ...
  Components.OneDimensional.WallConductionVertical1D firewall12(
  ...
  Components.OneDimensional.WallConductionVertical1D firewall23(
    redeclare model Mat = FirewallMat,
    x=t_fw_int,
    y=H_cell,
    z=W_cell,
  ...
  Components.OneDimensional.WallConductionVertical1D firewall1(
    redeclare model Mat = FirewallMat,
    x=t_fw_ext,
    y=H_cell,
    z=W_cell,
  ...
  Components.OneDimensional.WallConductionVertical1D firewall3(
    redeclare model Mat = FirewallMat,
    x=t_fw_ext,
    y=H_cell,
    z=W_cell,
  ...
  Components.OneDimensional.WallConductionHorizontal1D resin_top(
  ...
  Components.OneDimensional.WallConductionHorizontal1D resin_bottom(
    redeclare model Mat = ResinMat,
    x=t_module,
    y=t_resin,
    z=W_module,
  ...
  Components.OneDimensional.WallConductionHorizontal1D frame_bottom(
    redeclare model Mat = FrameMat,
    x=t_module,
    y=t_frame,
    z=W_module,
  ...
  Components.OneDimensional.WallConductionVertical1D frame_right(
    redeclare model Mat = FrameMat,
    x=t_frame,
    y=H_module,
    z=W_module,
  ...
  Components.OneDimensional.WallConductionVertical1D frame_left(
    redeclare model Mat = FrameMat,
    x=t_frame,
    y=H_module,
    z=W_module,
